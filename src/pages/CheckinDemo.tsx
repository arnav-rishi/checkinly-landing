      ...
      <section className="section-padding">
        <div className="container-max">
          ...
          <div className="mt-12 rounded-2xl overflow-hidden max-w-4xl mx-auto shadow-lg">
            <img src={hotelLobby} alt="Hotel Lobby" className="w-full h-auto object-cover" />
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-muted/30">
        <div className="container-max">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 max-w-4xl mx-auto">
            {verificationSteps.map((step, index) => <Card key={index} className="p-4 sm:p-6 hover:shadow-md transition-shadow text-center">
